...
export default function FloatingButtons() {
  ...
  return (
    <div className="fixed bottom-4 right-3 sm:bottom-6 sm:right-6 flex flex-col gap-2 sm:gap-3 z-50">
      {buttons.map((btn, i) => (
        <motion.div
          key={btn.id}
        ...
        >
          ...
          <motion.a
            ...
            className="w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center text-white shadow-lg transition-all duration-300"
